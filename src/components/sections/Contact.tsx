...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative w-full py-12 md:py-16 overflow-hidden">
        {backgroundImage && (
            <Image
      ...
      <div className="px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-1 md:gap-8 items-start">
            <div className="bg-card/80 backdrop-blur-sm p-4 md:py-2 md:px-6 rounded-lg shadow-md h-full">
