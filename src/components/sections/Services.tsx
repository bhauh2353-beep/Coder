        ...
        <div className="container mx-auto px-4 relative z-10">
            ...
            <Dialog open={modalOpen} onOpenChange={setModalOpen}>
                ...
                {services.map((service, index) => (
                    <Card key={index} className="text-center flex flex-col items-center shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-card/80 backdrop-blur-sm">
